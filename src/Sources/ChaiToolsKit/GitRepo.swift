...
class GitRepo {
    ...
    func execute(_ action: GitAction) throws {
        ...
        do {
            try isSafeToProceed(forAction: action)
        } catch let error {
            throw error
        }
        ...
        if process.terminationStatus == 0 {
            ...
            throw GitRepoFailStatus.unknown
        }
    }
    ...
    private func isSafeToProceed(forAction action: GitAction) throws {
